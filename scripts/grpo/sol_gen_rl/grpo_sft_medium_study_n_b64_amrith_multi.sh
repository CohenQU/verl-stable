...
task=Qwen3-1.7B-e3-math-medhard_0.35_0.001_0.001_1.0_32_b64_0721
dataset=e3-math-medhard
...
test_file=/project/flame/yuxiaoq/datasets/hmmt-aime-2025/test.parquet
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.total_epochs=10 > /home/yuxiaoq/workspace/log/ray/${experiment_name}.log 2>&1
